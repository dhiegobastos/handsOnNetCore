...
namespace hands_on_netcore.Service
{
    ...
    {
        public void ExecutarRegrasTurma()
        {
            ...
            Console.WriteLine($"Quantidade de alunos em todas as turmas: {quatidadeAlunos}");

            // Maior Nota entre todos os alunos
            var maiorNota = turmas.SelectMany(turma => turma.Alunos).Max(aluno => aluno.Nota);
            Console.WriteLine($"Maior Nota entre todos os alunos: {maiorNota}");
            ...
            Console.WriteLine($"Quantidade de alunos do sexo masculino: {alunosM}");
            ...
            Console.WriteLine($"Media de nota por turma: {String.Join("; ", mediaNotaAlunoPorTurma.Select(x => x.Media))}");
            
            var maiorTurma = turmas.Aggregate((curMin, x) => curMin.Alunos.Count() > x.Alunos.Count() ? curMin : x);
            Console.WriteLine($"Turma que tem o maior número de alunos: {maiorTurma.NomeTurma}; Quantidade de alunos: {maiorTurma.Alunos.Count()}");
            ...
            Console.WriteLine($"Quantidade de alunas que estão em mais de uma turma: {quantidadeMulheres}");
